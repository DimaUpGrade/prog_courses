"""
Django settings for prog_courses project.
...
SECRET_KEY = 'django-insecure-)n0txt^c4hkt1wg$y%*x6#1wdrzh_zfw(tlqg=0cbyn7hz^6wv'
...
WSGI_APPLICATION = 'prog_courses.wsgi.application'
